def tag_quote(self, **kwargs):
    ...
    from shutthatdown_admin_credentials import database_connection_details
    import psycopg2
    ...
    who_said_query = "select persons.id, persons.display_name from persons order by persons.display_name"
